      ...
      <div id="main" class="col-span-4">
        ...
        <div class="mt-20">
          ...
          <div class="mt-8 p-3 border rounded-lg bg-gray-50">
            ...
            <div class="grid grid-cols-3 gap-6 justify-around m-auto my-2">
              <div
                class="
                  col-span-3
                  md:col-span-1
          ...
          <div class="">
            <div class="font-bold">
              許多人在辛苦創業、業務推廣到一定規模時，赫然發現LOGO和別人的註冊商標相似。面臨究竟要放棄商標申請，日後可能商標侵權損害公司形象？或是宣布LOGO改版，裝潢、文宣重做，追加一筆龐大行銷預算支出？兩難的抉擇。
            </div>
          </div>
        </div>
        ...
        <div class="mt-20">
          <div class="flex items-center mb-4">
            ...
            <span class="text-2xl font-bold">STAR</span>
